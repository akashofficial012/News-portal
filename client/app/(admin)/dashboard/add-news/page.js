...
const CreateNews = () => {
    ...
    const added = async (e) => {
        ...
        try {
            setLoader(true)
            const  {data}  = await axios.post(`${base_url}/api/news/add-news`, formData, {
                headers: {
    ...
    return (
        <div className='bg-white rounded-md'>
            <div className='flex justify-between p-4'>
                ...
                <Link className='px-3 py-[6px] bg-purple-500 rounded-sm text-white hover:bg-purple-600' href='/dashboard/news'>News</Link>
